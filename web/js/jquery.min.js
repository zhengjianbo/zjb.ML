                ...
                if (els) {
                    ...
                    for (var i = 0; i < els.length; i++) {
                        ...
                        if (el.type == 'text') {
                            ...
                            if (el.outerHTML.indexOf('type=\"date\"') > -1 || el.outerHTML.indexOf("type='date'") > -1) {
                                el.onclick = function () { JTC.setday(this) };
                            } else if (el.outerHTML.indexOf("type=\"datetime\"") > -1 || el.outerHTML.indexOf("type=\"dateTime\"")>-1||el.outerHTML.indexOf("type='datetime'") > -1 || el.outerHTML.indexOf("type='dateTime'") > -1)
                            {
                                el.onclick = function () { JTC.setday(this) };
                            }
                        }
