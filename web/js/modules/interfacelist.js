...
layui.define(["table", "form"], function (t) {
    ...
    active = {
        ...
        load: function () {
            ...
            var $ = layui.$;
            var active = layui.interfacelist;
        ...
        open: function (title, t, data) {
            var _layer = layer.open({
                type: 2,
                title: title,
                content: 'interfacelistform.html',
                maxmin: true,
                area: ['700px', '550px'],
                btn: ['确定', '取消'],
                yes: function (e, i) {
        ...
        batchdel: function (ids) {
            ...
            layer.confirm('确定删除吗？', function (index) {
                ...
                layui.interfacelist.del(ids, function (msg) {
                    if (msg && msg.Success) {
                        tb.reload('LAY-app-content-list');
                        layer.msg('已删除');
                    }
    ...
    tb.render({
        ...
        "del" === t.event ? layer.confirm("确定删除此文章？", function (e) {
            layui.interfacelist.del([{ ID: data.ID }], function (msg) {
                if (msg && msg.Success) {
                    t.del(), layer.close(e);
                    layer.msg('已删除');
                }
        ...
        }) : "edit" === t.event && layui.interfacelist.open('编辑接口', t, data)
    }), t("interfacelist", active)
})